...
public class ParserTest {
    ...
    static final String[] validQNames = {"prefix:name","prefix:na me","name","name[name"};
    ...
    public void parseValidQNames(){
        ...
        for (String validQName : validQNames) {
            ...
            try {
                ...
                message.append("\nIllegalNameException has been occured on parsing valid name \""
		        + validQName + "\"");
            }
        }
        if (message.length()>0){
    ...
    public void parseIllegalQNames() throws IllegalNameException {
        ...
        for (String illegalQName : illegalQNames) {
            try {
                ...
                message.append("\nIllegalNameException is not thrown on parsing illegal name \""
		        + illegalQName + "\"");
            } catch (IllegalNameException e) {
            } catch (Exception e) {
